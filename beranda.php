...
<!--close-top-serch-->
<!--sidebar-menu-->
<div id="sidebar"><a href="beranda.php" class="visible-phone"><i class="icon icon-home"></i> HOME</a>
  <ul>
  <?php
    if($r['id_level'] == 1){
  ?>
    <li class="active"><a href="beranda.php"><i class="icon icon-home"></i> <span>Beranda</span></a> </li>
    <li> <a href="entri_referensi.php"><i class="icon icon-tasks"></i> <span>Menu</span></a> </li>
  ...
  <div class="container-fluid">
    ...
    ?>
      ...
      <div class="alert alert-orange alert-block">
        <center>
          <h4 class="alert-heading">WELCOME TO RESTAURANT INDAH AIDA SAPITRI</h4>
         Restaurant cepat saji
          <br> Selamat menikmati dan semoga hari mu menyenangkan. 
        </center>
      </div>
      <?php
        }
