...
<!--Header-part-->
<div id="header">
  <h1><a href="entri_referensi.php">Menu</a></h1>
</div>
<!--close-Header-part--> 
...
<div id="sidebar">
  ...
  <ul>
    ...
    <li class="active"> <a href="entri_referensi.php"><i class="icon icon-tasks"></i> <span>Menu</span></a> </li>
    <li> <a href="widgets.html"><i class="icon icon-shopping-cart"></i> <span>Pesanan</span></a> </li>
    <li> <a href="widgets.html"><i class="icon icon-inbox"></i> <span>ransaksi</span></a> </li>
    <li> <a href="widgets.html"><i class="icon icon-print"></i> <span>Laporan</span></a> </li>
  </ul>
</div>
<!--sidebar-menu-->
        ...
        <div class="widget-content" >
          <form action="" method="post" class="form-horizontal" accept-charset="UTF-8" enctype="multipart/form-data">
            <div class="control-group">
              <label class="control-label">Nama Masakan/Minuman:</label>
              <div class="controls">
                <?php 
                  if(isset($_SESSION['edit_menu'])){
                ?>
...
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date('Y'); ?> &copy; Restaurant <a href="#">by indahaidasapitri</a> </div>
</div>
